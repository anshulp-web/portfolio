    ...
    >
      ...
      <div className="flex relative h-full justify-between gap-x-3">
        ...
        >
          ...
          <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90 flex items-center justify-center text-center text-xl text-gray-600 font-extrabold tracking-widest"></span>
        </div>
